...
- 목록 행 클릭 또는 `↑/↓` 키 이동 시 Double/Triple 이미지 즉시 갱신
- 서로 다른 해상도·종횡비도 같은 크기의 letterbox 미리보기로 표시
- 리스트 창은 상단 전체 목록, 하단 Double/Triple 이미지 구조
